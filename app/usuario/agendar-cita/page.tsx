...
export default function AgendarCita() {
    ...
    const fetchAvailableHours = async (selectedDate: Date) => {
        ...
        if (response.ok) {
            ...
            console.error('Error al obtener las horas disponibles:', response.statusText);
        }
    };
    ...
    useEffect(() => {
        if (session) {
            setFormData(prev => ({
                ...prev,
                usuarioId: session.user.id, // Asigna el ID del usuario al formData
                nombre: session.user.name, // Asigna el nombre del usuario al formData
            }));
        }
    }, [session]);
                ...
                <div className="bg-[#FFEBA9] rounded-3xl"> 
                    <div className="flex flex-col">                 
                        ...
                        <div className="items-start px-[50px]"><br />
                            <div className="flex justify-end"><Link href="/usuario" className="hover:text-[#E55E7F] font-extrabold text-[22px]">Volver</Link></div>
                        ...
                        <div className="formUserDiv"> 
                            ...
                            <div className="formUserForm"><br />
                                <form className="w-full pl-4" onSubmit={handleSumbmit}>{/*Formulario*/}
                                    <h3 className="formUserSubtitle">Cita</h3>
